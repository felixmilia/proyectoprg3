...
import './styles.css'
function Tvsopulares() {
    return (
        <section class="row cards" id="tv-show">
            <article class="single-card-tv">
                <img src="https://image.tmdb.org/t/p/w500/9mYeRoWguq5etbwJRdF8BXFKiF.jpg" class="card-img-top"alt="..."></img>
                    <div class="cardBody">
            ...
            <article class="single-card-tv">
                <img src="https://image.tmdb.org/t/p/w500/yueXS3q8BtoWekcHOATFHicLl3e.jpg" class="card-img-top"alt="..."></img>
                    <div class="cardBody">
            ...
            <article class="single-card-tv">
                <img src="https://image.tmdb.org/t/p/w500/yb4F1Oocq8GfQt6iIuAgYEBokhG.jpg" class="card-img-top"alt="..."></img>
                    <div class="cardBody">
            ...
            <article class="single-card-tv">
                <img src="https://image.tmdb.org/t/p/w500/6TPGDrU9MyWbn2TpggJphVAVXiq.jpg" class="card-img-top"alt="..."></img>
                    <div class="cardBody">
            ...
            <article class="single-card-tv">
                <img src="https://image.tmdb.org/t/p/w500/3m1UaMLgmpj6krNaQwTpftYFsnz.jpg" class="card-img-top"alt="..."></img>
                    <div class="cardBody">
