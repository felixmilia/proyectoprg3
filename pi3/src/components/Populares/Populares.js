  ...
  return (
        <section class="row cards" id="movies">
            <article class="single-card-movie">
                <img src="https://image.tmdb.org/t/p/w500/tzrJulItjttxzoX0t3B2My46TS7.jpg" class="card-img-top"alt="..."></img>
                <div class="cardBody">
            ...
            <article class="single-card-movie">
                <img src="https://image.tmdb.org/t/p/w500/9PXZIUsSDh4alB80jheWX4fhZmy.jpg" class="card-img-top"alt="..."></img>
                <div class="cardBody">
            ...
            <article class="single-card-movie">
                <img src="https://image.tmdb.org/t/p/w500/ombsmhYUqR4qqOLOxAyr5V8hbyv.jpg" class="card-img-top" alt="..."></img>
                <div class="cardBody">
